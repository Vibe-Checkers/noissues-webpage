...
import { Container, FileCode, CheckCircle, Sparkles, Database } from 'lucide-react';
...
export function Hero({ onTryOut, onOpenExplorer }: HeroProps) {
	return (
			...
			<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
				<div className="text-center">
					...
					<div className="flex flex-wrap justify-center gap-4">
						<button
							onClick={onTryOut}
							className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center gap-2 text-lg"
						>
						...
						<button
							...
							className="px-8 py-4 bg-slate-800/80 hover:bg-slate-700 text-white rounded-xl transition-all border border-slate-700 backdrop-blur-sm flex items-center gap-2 text-lg"
						>
